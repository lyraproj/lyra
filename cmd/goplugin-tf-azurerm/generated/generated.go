...
func Initialize(sb *service.ServerBuilder, p *schema.Provider) {
    var evs []eval.Type
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_batch_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_batch_accountHandler", &Azurerm_batch_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_key_vault_secret{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_key_vault_secretHandler", &Azurerm_key_vault_secretHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb_nat_pool{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lb_nat_poolHandler", &Azurerm_lb_nat_poolHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_watcher{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_watcherHandler", &Azurerm_network_watcherHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_resource_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_resource_groupHandler", &Azurerm_resource_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_active_directory_administrator{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_active_directory_administratorHandler", &Azurerm_sql_active_directory_administratorHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_machine_data_disk_attachment{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_machine_data_disk_attachmentHandler", &Azurerm_virtual_machine_data_disk_attachmentHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_app_service_active_slot{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_app_service_active_slotHandler", &Azurerm_app_service_active_slotHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_cdn_endpoint{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_cdn_endpointHandler", &Azurerm_cdn_endpointHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_a_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_a_recordHandler", &Azurerm_dns_a_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_virtual_network_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_virtual_network_ruleHandler", &Azurerm_sql_virtual_network_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_network{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_networkHandler", &Azurerm_virtual_networkHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_credential{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_credentialHandler", &Azurerm_automation_credentialHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_data_lake_analytics_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_data_lake_analytics_accountHandler", &Azurerm_data_lake_analytics_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_data_lake_store_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_data_lake_store_firewall_ruleHandler", &Azurerm_data_lake_store_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_iothub{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_iothubHandler", &Azurerm_iothubHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mysql_configuration{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mysql_configurationHandler", &Azurerm_mysql_configurationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_queue{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_queueHandler", &Azurerm_servicebus_queueHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_machine_extension{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_machine_extensionHandler", &Azurerm_virtual_machine_extensionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_security_center_workspace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_security_center_workspaceHandler", &Azurerm_security_center_workspaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_runbook{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_runbookHandler", &Azurerm_automation_runbookHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_batch_pool{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_batch_poolHandler", &Azurerm_batch_poolHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_key_vault_certificate{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_key_vault_certificateHandler", &Azurerm_key_vault_certificateHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_key_vault{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_key_vaultHandler", &Azurerm_key_vaultHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_managed_disk{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_managed_diskHandler", &Azurerm_managed_diskHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_postgresql_database{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_postgresql_databaseHandler", &Azurerm_postgresql_databaseHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_route_table{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_route_tableHandler", &Azurerm_route_tableHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_namespace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_namespaceHandler", &Azurerm_servicebus_namespaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_app_service_plan{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_app_service_planHandler", &Azurerm_app_service_planHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_app_service{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_app_serviceHandler", &Azurerm_app_serviceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_firewall_application_rule_collection{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_firewall_application_rule_collectionHandler", &Azurerm_firewall_application_rule_collectionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_security_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_security_groupHandler", &Azurerm_network_security_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_security_center_contact{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_security_center_contactHandler", &Azurerm_security_center_contactHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_subnet_network_security_group_association{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_subnet_network_security_group_associationHandler", &Azurerm_subnet_network_security_group_associationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_app_service_custom_hostname_binding{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_app_service_custom_hostname_bindingHandler", &Azurerm_app_service_custom_hostname_bindingHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_azuread_service_principal{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_azuread_service_principalHandler", &Azurerm_azuread_service_principalHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dev_test_linux_virtual_machine{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dev_test_linux_virtual_machineHandler", &Azurerm_dev_test_linux_virtual_machineHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventgrid_topic{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventgrid_topicHandler", &Azurerm_eventgrid_topicHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_express_route_circuit{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_express_route_circuitHandler", &Azurerm_express_route_circuitHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_policy_definition{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_policy_definitionHandler", &Azurerm_policy_definitionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_data_lake_store_file{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_data_lake_store_fileHandler", &Azurerm_data_lake_store_fileHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_aaaa_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_aaaa_recordHandler", &Azurerm_dns_aaaa_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_cname_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_cname_recordHandler", &Azurerm_dns_cname_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_firewall{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_firewallHandler", &Azurerm_firewallHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_image{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_imageHandler", &Azurerm_imageHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_log_analytics_solution{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_log_analytics_solutionHandler", &Azurerm_log_analytics_solutionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mysql_server{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mysql_serverHandler", &Azurerm_mysql_serverHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_security_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_security_ruleHandler", &Azurerm_network_security_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_notification_hub{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_notification_hubHandler", &Azurerm_notification_hubHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_role_assignment{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_role_assignmentHandler", &Azurerm_role_assignmentHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_azuread_application{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_azuread_applicationHandler", &Azurerm_azuread_applicationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventhub_consumer_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventhub_consumer_groupHandler", &Azurerm_eventhub_consumer_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_key_vault_access_policy{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_key_vault_access_policyHandler", &Azurerm_key_vault_access_policyHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_policy_assignment{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_policy_assignmentHandler", &Azurerm_policy_assignmentHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_postgresql_configuration{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_postgresql_configurationHandler", &Azurerm_postgresql_configurationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_recovery_services_vault{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_recovery_services_vaultHandler", &Azurerm_recovery_services_vaultHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_role_definition{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_role_definitionHandler", &Azurerm_role_definitionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mysql_virtual_network_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mysql_virtual_network_ruleHandler", &Azurerm_mysql_virtual_network_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_api_management{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_api_managementHandler", &Azurerm_api_managementHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_module{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_moduleHandler", &Azurerm_automation_moduleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_autoscale_setting{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_autoscale_settingHandler", &Azurerm_autoscale_settingHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_express_route_circuit_peering{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_express_route_circuit_peeringHandler", &Azurerm_express_route_circuit_peeringHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb_probe{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lb_probeHandler", &Azurerm_lb_probeHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_trigger_recurrence{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_trigger_recurrenceHandler", &Azurerm_logic_app_trigger_recurrenceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_workflow{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_workflowHandler", &Azurerm_logic_app_workflowHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_redis_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_redis_firewall_ruleHandler", &Azurerm_redis_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_container_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_container_groupHandler", &Azurerm_container_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_ns_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_ns_recordHandler", &Azurerm_dns_ns_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_management_lock{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_management_lockHandler", &Azurerm_management_lockHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_notification_hub_namespace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_notification_hub_namespaceHandler", &Azurerm_notification_hub_namespaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_service_fabric_cluster{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_service_fabric_clusterHandler", &Azurerm_service_fabric_clusterHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_network_gateway_connection{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_network_gateway_connectionHandler", &Azurerm_virtual_network_gateway_connectionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_topic{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_topicHandler", &Azurerm_servicebus_topicHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_container_registry{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_container_registryHandler", &Azurerm_container_registryHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_devspace_controller{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_devspace_controllerHandler", &Azurerm_devspace_controllerHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_srv_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_srv_recordHandler", &Azurerm_dns_srv_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventhub_namespace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventhub_namespaceHandler", &Azurerm_eventhub_namespaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_key_vault_key{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_key_vault_keyHandler", &Azurerm_key_vault_keyHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_public_ip{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_public_ipHandler", &Azurerm_public_ipHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_subscription_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_subscription_ruleHandler", &Azurerm_servicebus_subscription_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_server{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_serverHandler", &Azurerm_sql_serverHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_dsc_nodeconfiguration{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_dsc_nodeconfigurationHandler", &Azurerm_automation_dsc_nodeconfigurationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_azuread_service_principal_password{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_azuread_service_principal_passwordHandler", &Azurerm_azuread_service_principal_passwordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_monitor_diagnostic_setting{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_monitor_diagnostic_settingHandler", &Azurerm_monitor_diagnostic_settingHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_packet_capture{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_packet_captureHandler", &Azurerm_packet_captureHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_redis_cache{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_redis_cacheHandler", &Azurerm_redis_cacheHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_shared_image{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_shared_imageHandler", &Azurerm_shared_imageHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_signalr_service{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_signalr_serviceHandler", &Azurerm_signalr_serviceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_table{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_tableHandler", &Azurerm_storage_tableHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_template_deployment{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_template_deploymentHandler", &Azurerm_template_deploymentHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mssql_elasticpool{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mssql_elasticpoolHandler", &Azurerm_mssql_elasticpoolHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_application_gateway{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_application_gatewayHandler", &Azurerm_application_gatewayHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_caa_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_caa_recordHandler", &Azurerm_dns_caa_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_zone{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_zoneHandler", &Azurerm_dns_zoneHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_iothub_consumer_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_iothub_consumer_groupHandler", &Azurerm_iothub_consumer_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb_backend_address_pool{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lb_backend_address_poolHandler", &Azurerm_lb_backend_address_poolHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lbHandler", &Azurerm_lbHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_monitor_metric_alert{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_monitor_metric_alertHandler", &Azurerm_monitor_metric_alertHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mysql_database{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mysql_databaseHandler", &Azurerm_mysql_databaseHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_traffic_manager_profile{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_traffic_manager_profileHandler", &Azurerm_traffic_manager_profileHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lb_ruleHandler", &Azurerm_lb_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_management_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_management_groupHandler", &Azurerm_management_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_monitor_log_profile{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_monitor_log_profileHandler", &Azurerm_monitor_log_profileHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_interface_application_gateway_backend_address_pool_association{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_interface_application_gateway_backend_address_pool_associationHandler", &Azurerm_network_interface_application_gateway_backend_address_pool_associationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_accountHandler", &Azurerm_storage_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_machine_scale_set{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_machine_scale_setHandler", &Azurerm_virtual_machine_scale_setHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_data_lake_store{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_data_lake_storeHandler", &Azurerm_data_lake_storeHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dev_test_lab{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dev_test_labHandler", &Azurerm_dev_test_labHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventhub_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventhub_authorization_ruleHandler", &Azurerm_eventhub_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_policy_set_definition{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_policy_set_definitionHandler", &Azurerm_policy_set_definitionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_accountHandler", &Azurerm_automation_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_databricks_workspace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_databricks_workspaceHandler", &Azurerm_databricks_workspaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_log_analytics_workspace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_log_analytics_workspaceHandler", &Azurerm_log_analytics_workspaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_trigger_custom{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_trigger_customHandler", &Azurerm_logic_app_trigger_customHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_notification_hub_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_notification_hub_authorization_ruleHandler", &Azurerm_notification_hub_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_search_service{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_search_serviceHandler", &Azurerm_search_serviceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventhub{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventhubHandler", &Azurerm_eventhubHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_express_route_circuit_authorization{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_express_route_circuit_authorizationHandler", &Azurerm_express_route_circuit_authorizationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_subscription{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_subscriptionHandler", &Azurerm_servicebus_subscriptionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_topic_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_topic_authorization_ruleHandler", &Azurerm_servicebus_topic_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_network_peering{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_network_peeringHandler", &Azurerm_virtual_network_peeringHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_interface_backend_address_pool_association{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_interface_backend_address_pool_associationHandler", &Azurerm_network_interface_backend_address_pool_associationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_scheduler_job_collection{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_scheduler_job_collectionHandler", &Azurerm_scheduler_job_collectionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_namespace_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_namespace_authorization_ruleHandler", &Azurerm_servicebus_namespace_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_firewall_ruleHandler", &Azurerm_sql_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_traffic_manager_endpoint{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_traffic_manager_endpointHandler", &Azurerm_traffic_manager_endpointHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_availability_set{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_availability_setHandler", &Azurerm_availability_setHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_cognitive_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_cognitive_accountHandler", &Azurerm_cognitive_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_lb_nat_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_lb_nat_ruleHandler", &Azurerm_lb_nat_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_action_custom{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_action_customHandler", &Azurerm_logic_app_action_customHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_metric_alertrule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_metric_alertruleHandler", &Azurerm_metric_alertruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_route{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_routeHandler", &Azurerm_routeHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_elasticpool{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_elasticpoolHandler", &Azurerm_sql_elasticpoolHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_function_app{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_function_appHandler", &Azurerm_function_appHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mysql_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mysql_firewall_ruleHandler", &Azurerm_mysql_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_scheduler_job{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_scheduler_jobHandler", &Azurerm_scheduler_jobHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_servicebus_queue_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_servicebus_queue_authorization_ruleHandler", &Azurerm_servicebus_queue_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_shared_image_gallery{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_shared_image_galleryHandler", &Azurerm_shared_image_galleryHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_subnet{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_subnetHandler", &Azurerm_subnetHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_monitor_activity_log_alert{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_monitor_activity_log_alertHandler", &Azurerm_monitor_activity_log_alertHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_recovery_services_protection_policy_vm{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_recovery_services_protection_policy_vmHandler", &Azurerm_recovery_services_protection_policy_vmHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_sql_database{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_sql_databaseHandler", &Azurerm_sql_databaseHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_subnet_route_table_association{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_subnet_route_table_associationHandler", &Azurerm_subnet_route_table_associationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_postgresql_server{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_postgresql_serverHandler", &Azurerm_postgresql_serverHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_schedule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_scheduleHandler", &Azurerm_automation_scheduleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_data_lake_analytics_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_data_lake_analytics_firewall_ruleHandler", &Azurerm_data_lake_analytics_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_log_analytics_workspace_linked_service{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_log_analytics_workspace_linked_serviceHandler", &Azurerm_log_analytics_workspace_linked_serviceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_action_http{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_action_httpHandler", &Azurerm_logic_app_action_httpHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mariadb_database{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mariadb_databaseHandler", &Azurerm_mariadb_databaseHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_interface_nat_rule_association{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_interface_nat_rule_associationHandler", &Azurerm_network_interface_nat_rule_associationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_postgresql_firewall_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_postgresql_firewall_ruleHandler", &Azurerm_postgresql_firewall_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_blob{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_blobHandler", &Azurerm_storage_blobHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_app_service_slot{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_app_service_slotHandler", &Azurerm_app_service_slotHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_application_insights{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_application_insightsHandler", &Azurerm_application_insightsHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_postgresql_virtual_network_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_postgresql_virtual_network_ruleHandler", &Azurerm_postgresql_virtual_network_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_snapshot{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_snapshotHandler", &Azurerm_snapshotHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_user_assigned_identity{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_user_assigned_identityHandler", &Azurerm_user_assigned_identityHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_network_gateway{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_network_gatewayHandler", &Azurerm_virtual_network_gatewayHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_application_insights_api_key{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_application_insights_api_keyHandler", &Azurerm_application_insights_api_keyHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_eventhub_namespace_authorization_rule{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_eventhub_namespace_authorization_ruleHandler", &Azurerm_eventhub_namespace_authorization_ruleHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_security_center_subscription_pricing{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_security_center_subscription_pricingHandler", &Azurerm_security_center_subscription_pricingHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_shared_image_version{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_shared_image_versionHandler", &Azurerm_shared_image_versionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_cdn_profile{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_cdn_profileHandler", &Azurerm_cdn_profileHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_container_service{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_container_serviceHandler", &Azurerm_container_serviceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_mx_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_mx_recordHandler", &Azurerm_dns_mx_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_logic_app_trigger_http_request{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_logic_app_trigger_http_requestHandler", &Azurerm_logic_app_trigger_http_requestHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_relay_namespace{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_relay_namespaceHandler", &Azurerm_relay_namespaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_share{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_shareHandler", &Azurerm_storage_shareHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_virtual_machine{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_virtual_machineHandler", &Azurerm_virtual_machineHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_queue{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_queueHandler", &Azurerm_storage_queueHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_cosmosdb_account{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_cosmosdb_accountHandler", &Azurerm_cosmosdb_accountHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_ptr_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_ptr_recordHandler", &Azurerm_dns_ptr_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_network_interface{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_network_interfaceHandler", &Azurerm_network_interfaceHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_storage_container{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_storage_containerHandler", &Azurerm_storage_containerHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_automation_dsc_configuration{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_automation_dsc_configurationHandler", &Azurerm_automation_dsc_configurationHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dev_test_windows_virtual_machine{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dev_test_windows_virtual_machineHandler", &Azurerm_dev_test_windows_virtual_machineHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dns_txt_record{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dns_txt_recordHandler", &Azurerm_dns_txt_recordHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_firewall_network_rule_collection{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_firewall_network_rule_collectionHandler", &Azurerm_firewall_network_rule_collectionHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_kubernetes_cluster{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_kubernetes_clusterHandler", &Azurerm_kubernetes_clusterHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_local_network_gateway{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_local_network_gatewayHandler", &Azurerm_local_network_gatewayHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_recovery_services_protected_vm{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_recovery_services_protected_vmHandler", &Azurerm_recovery_services_protected_vmHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_application_security_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_application_security_groupHandler", &Azurerm_application_security_groupHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dev_test_policy{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dev_test_policyHandler", &Azurerm_dev_test_policyHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_dev_test_virtual_network{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_dev_test_virtual_networkHandler", &Azurerm_dev_test_virtual_networkHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_mariadb_server{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_mariadb_serverHandler", &Azurerm_mariadb_serverHandler{provider: p}, evs[0])
    evs = sb.RegisterTypes("TerraformGoogle", Azurerm_monitor_action_group{})
    sb.RegisterHandler("TerraformGoogle::Azurerm_monitor_action_groupHandler", &Azurerm_monitor_action_groupHandler{provider: p}, evs[0])
}
